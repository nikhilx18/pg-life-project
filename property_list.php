        ...
        <?php
          ...
          elseif( mysqli_num_rows($properties_result)==0 )
          {
            ...
            <div class="no-pg mx-4 my-5">
              <h2>New PG Listings Will Be Available Soon in <?php echo $city; ?>!</h2>
              <hr>

              <p>
             We are currently expanding our network to provide verified and affordable PG accommodations
        for students and working professionals in <?php echo $city; ?>.
              </p>

              <br>

               <p>
                   Stay connected with PG Life for verified student accommodations, affordable pricing, and a seamless booking experience. We look forward to serving you in <?php echo $city; ?> soon.
                </p>
                </div>
                <?php
          }
